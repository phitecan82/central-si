    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>                          
                                <tr>
                                    ...
                                    <td class="text-center">  
                                    {!! cui_btn_delete(route('admin.sidang_ta.show', [$sidangta->id]), "Anda yakin akan menghapus data dosen ini?") !!}  
                                    </td>
                                </tr>
                        </tbody>
                    </table>
                ...
                <input type="submit" class="btn btn-danger" value="Hapus sidangta Penguji Sidang"/>
