            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="semhas_at"><strong>Semhas_at</strong></label>
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('nama',$ruangan, null, ['class' => 'form-control-plaintext', 'id' => 'nama', 'readonly' => 'readonly']) }}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('status', null, ['class' => 'form-control-plaintext', 'id' => 'status', 'readonly' => 'readonly']) }}
                    </div>
                    <div class="form-group">
                        <label for="rekomendasi"><strong>Rekomendasi</strong></label>
                        {{ Form::text('rekomendasi', null, ['class' => 'form-control-plaintext', 'id' => 'rekomendasi', 'readonly' => 'readonly']) }}
                    </div>
                    <div class="form-group">
